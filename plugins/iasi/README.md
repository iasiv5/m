...
- 在聊天中直接输入 `/brainstorming`、`/writing-plans`、`/handoff` 或 `/cleanup` 手动调用 skill
...
- 已包含：2 个 custom agents、4 个 skills、1 个 command prompt、1 条 workspace-wide instruction、1 个空 hooks 占位文件
- 未包含：非空 hooks 实现
- 未包含：MCP server
- 未包含：依赖本地绝对安装路径的分发逻辑
